...
function Campinglist() {
    ...
    const nullImgUrl = 'http://www.myeongin.net/app/dubu_board/docs/imgs/d/d16124045780126_%EC%9D%B4%EB%AF%B8%EC%A7%80%EC%A4%80%EB%B9%84%EC%A4%91.jpg';
                    ...
                    {currentCamps === "없음" ? (
                        ...
                        currentCamps.map(campi => (
                            <Link to={`/CampingDetail/${campi.id}`} key={campi.id}>
                                <li>
                                    <img src={campi.imgurl ? campi.imgurl : nullImgUrl} className='camping-imgurl'/>
